...
const ones = new TotalOneNumber({ val: 1, description: "1 point for 1" });
const twos = new TotalOneNumber({ val: 2, description: "2 points for 2" });
const threes = new TotalOneNumber({ val: 3, description: "3 points for 3" });
const fours = new TotalOneNumber({ val: 4, description: "4 points for 4" });
const fives = new TotalOneNumber({ val: 5, description: "5 points for 5" });
const sixes = new TotalOneNumber({ val: 6, description: "6 points for 6" });
